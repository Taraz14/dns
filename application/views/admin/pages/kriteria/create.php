            ...
            <div class="ibox-content">
				<?= form_open(''); ?>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                        	<input type="text" placeholder="Nama Kriteria" name="name" class="form-control" value="<?= set_value('name') ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                        	<input type="text" placeholder="Bobot" name="bobot" class="form-control" value="<?= set_value('bobot') ?>">
